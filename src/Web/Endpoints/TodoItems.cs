using CleanArchToDoExample.Application.Common.Models;
using CleanArchToDoExample.Application.TodoItems.Commands.CreateTodoItem;
using CleanArchToDoExample.Application.TodoItems.Commands.DeleteTodoItem;
using CleanArchToDoExample.Application.TodoItems.Commands.UpdateTodoItem;
using CleanArchToDoExample.Application.TodoItems.Commands.UpdateTodoItemDetail;
using CleanArchToDoExample.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace CleanArchToDoExample.Web.Endpoints;
